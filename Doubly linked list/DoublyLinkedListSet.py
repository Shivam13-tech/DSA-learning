...
class DoublyLinkedList:               
    ...
    def get(self,index):
        ...
        if index <= self.length / 2:             #i.e if index is less then half our linked list length then
            ...
            for _ in range(self.length - 1, index, -1):  #index is passed for range, second parameter is length - 1 and third parameter is decrement by 1
                temp = temp.prev
        return temp
...
my_doubly_linked_list.set_value(3,18)
